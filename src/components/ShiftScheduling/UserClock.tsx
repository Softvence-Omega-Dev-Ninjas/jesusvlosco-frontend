                              ...
                              <div className="bg-white rounded-lg shadow-sm p-6">
                                    ...
                                    <div className="grid grid-cols-3 gap-8">
                                          <div>
                                                ...
                                                <p className="text-lg font-semibold text-gray-900">{timeEntry.clockIn}</p>
                                          </div>
                                          <div>
                                                <h3 className="text-sm font-medium text-gray-700 mb-2">Clock Out</h3>
                                                <p className="text-lg font-semibold text-gray-900">{timeEntry.clockOut}</p>
                                          </div>
                                          <div>
                                                <h3 className="text-sm font-medium text-gray-700 mb-2">Hours Today</h3>
                                                <p className="text-lg font-semibold text-gray-900">{timeEntry.hoursWorked} / {timeEntry.totalHours}</p>
                                          </div>
                                    </div>
                              </div>
                                                            ...
                                                            <div key={request.id} className="border  border-gray-200 rounded-lg p-4 py-11 bg-gray-50">
                                                                  <div className="flex justify-between items-start mb-3">
                                                                        <div className="flex-1">
                                                                              <p className="font-medium text-gray-900 mb-1">{request.dateRange}</p>
                        ...
                        <div className="space-y-6">
                              ...
                              <div className="bg-white rounded-lg shadow-sm p-6">
                                    ...
                                    <div className="space-y-3">
                                          ...
                                          <button onClick={() => setIsModalOpen(true)} className="w-full flex items-center gap-3 px-4 py-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                                <Plus className="w-5 h-5 text-gray-600" />
                                                <span className="text-sm font-medium text-gray-700">Add a time off request</span>
                                          </button>
                                          <TimeOffRequestModal
                                                isOpen={isModalOpen}
