...
const PublishedFilterDropdown: FC = () => {
      ...
      return (
            <div className="relative inline-block" ref={dropdownRef}>
                  ...
                  >
                        Published/Draft {open ? <HiChevronUp className="w-4 h-4 mmt-1" /> : <HiChevronDown className="w-4 h-4 mt-1" />}
                  </button>
...
export default PublishedFilterDropdown;
