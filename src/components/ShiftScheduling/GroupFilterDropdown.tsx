...
const options = [
      "All users group", "All admins group", "Project 1", "Project 2",
      "Project 3", "Project 4", "Male", "Female", "Other"
];
      ...
      return (
            <div className="relative inline-block" ref={dropdownRef}>
                  ...
                  <button
                        ...
                        className="text-sm border border-indigo-300 text-indigo-700 px-3 py-1.5 rounded-full bg-white flex items-center gap-1"
                  >
                        Group {open ? <HiChevronUp className="w-4 h-4" /> : <HiChevronDown className="w-4 h-4" />}
                  </button>
