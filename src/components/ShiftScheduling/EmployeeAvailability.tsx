...
const EmployeeAvailability = ({
  ...
  const onSubmit = (
    ...
    const formData: ShiftAPIData = {
      ...
      locationLat: data.locationCoordinates?.latitude || 0,
      locationLng: data.locationCoordinates?.longitude || 0,
      note: data.note,
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mb-1 text-sm text-gray-600 mt-1">
                  <button
                    onClick={() => handleAssignUser(emp.user.id as string, idx)}
                    className="text-lg"
                  >
                    <BsStopwatch />
                  </button>
              ...
              {openIndex === idx && (
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 z-50 bg-white border border-gray-200 rounded-xl shadow-lg p-4 min-w-2xl">
                  <button
                  ...
                  <Tab.Group className="p-1">
                    <Tab.List className="flex space-x-4 mb-4">
                      {["Shift Details", "Shift Tasks", "Shift Activity"].map(
                        (tab, tabIdx) => (
                          <Tab
                            key={tabIdx}
                            className={({ selected }) =>
