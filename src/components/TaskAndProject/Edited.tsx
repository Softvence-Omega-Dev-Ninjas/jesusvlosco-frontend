                  ...
                  <div className="w-full max-w-md bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-100">
                              <div className="flex items-center space-x-3">
                                    ...
                                    <h1 className="text-lg font-medium text-gray-900">Edit Task</h1>
                              </div>
                        </div>
                        ...
                        <div className="p-6 space-y-6">
                              ...
                              <div>
                                    <h2 className="text-sm font-medium text-gray-700 mb-4">Task Details</h2>
                                    ...
                                    <div className="mb-4">
                                          ...
                                          <div className="relative">
                                                ...
                                                <div className="absolute bottom-3 right-3">
                                                      ...
                                                      <span className="text-xs text-gray-400 ml-1">Attachment</span>
                                                </div>
                                          </div>
                                    </div>
