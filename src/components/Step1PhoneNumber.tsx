...
const Step1PhoneNumber: React.FC<Step1PhoneNumberProps> = ({ onSubmit }) => {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => { // Type event object as FormEvent
        e.preventDefault();
        // In a real app, you'd send this number to your backend to send a verification code
        onSubmit(`${countryCode} ${number}`);
    };
            ...
            <form onSubmit={handleSubmit}>
                <div className="flex items-center border border-gray-300 rounded-md p-2 mb-4">
                    <select
                        ...
                        value={countryCode}
                        onChange={(e: ChangeEvent<HTMLSelectElement>) => setCountryCode(e.target.value)} // Type event object as ChangeEvent<HTMLSelectElement>
                    >
                    ...
                    <input
                        ...
                        value={number}
                        onChange={(e: ChangeEvent<HTMLInputElement>) => setNumber(e.target.value)} // Type event object as ChangeEvent<HTMLInputElement>
                        required
                    />
                </div>
