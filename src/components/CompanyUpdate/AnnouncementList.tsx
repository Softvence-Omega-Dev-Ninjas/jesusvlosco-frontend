...
//     const [announcementList, setAnnouncementList] = useState(announcementsData);
...
//                     </p>
//                     <button
//                         onClick={() => setShowModal(true)} // ⬅️ show modal instead of delete
//                         className="flex items-center gap-1 text-white bg-red-600 hover:bg-red-700 px-3 py-1 rounded text-sm"
//                     >
//                         <RiDeleteBin6Line className="w-4 h-4" />
//                         Delete
...
//                                         setShowMenu(false);
//                                     }}
//                                     className="w-full flex gap-2 px-4 py-2 text-sm text-indigo-800 hover:bg-gray-100 text-left"
//                                 >
...
//                         {selectedId === a.id ? (
//                             <RemotePolicyCard onClose={() => setSelectedId(null)} />
//                         ) : (
//                             <>
//                                 <div className={`flex gap-4 ${showDeleteMode ? 'pl-10' : ''}`}>
//                                     <div className="mt-2 border-r border-gray-300 px-2">
//                                         <p className="text-sm text-gray-400">Today <br />{a.time}</p>
//                                     </div>
...
//                                             {a.tags.map((tag, i) => (
//                                                 <span key={i} className="bg-indigo-100 text-indigo-800 px-3 py-1 rounded-lg text-xs font-medium">
//                                                     {tag}
//                                                 </span>
//                                             ))}
//                                         </div>
...
//                         <button
//                             key={pageNumber}
//                             className={`px-3 py-1 rounded-md text-sm ${currentPage === pageNumber ? 'bg-indigo-500 text-white font-medium' : 'hover:bg-gray-100'}`}
...
//                         <button
//                             className={`px-3 py-1 rounded-md text-sm ${currentPage === totalPages ? 'bg-indigo-500 text-white font-medium' : 'hover:bg-gray-100'}`}
