                      ...
                      <React.Fragment key={`week-${weekIndex}`}>
                        ...
                        <tr>
                          ...
                          >
                            ...
                            (Weekly Total: {week.weeklyTotal?.toFixed(2)} hours)
                          </td>
                        </tr>
                        ...
                        {[...(week.days || [])]
                          ...
                          .map(
                            (
                              day: { entries: any[]; totalHours: number },
                              dayIndex: number
                            ) => (
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <td className="text-gray-500 bg-white min-w-[100px] sm:min-w-[120px] text-sm">
                                            {entry?.shift?.title != null
                                              ? String(entry?.shift?.title)
                                              : ""}
                                          </td>
