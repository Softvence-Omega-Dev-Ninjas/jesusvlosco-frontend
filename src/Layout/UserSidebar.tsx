...
const navigation: NavigationItem[] = [
...

  {
    ...
    hasSubmenu: true,
    submenu: [
      { name: "Shift Scheduling", icon: Calendar, path: "/user/user-schedule/user-shift-schedule" },
      ...
      { name: "Clock In Request", icon: Clock, path: "/user/user-schedule/user-clock-in-request" },
    ],
  },
