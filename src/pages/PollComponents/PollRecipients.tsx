...
const PollRecipients = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-2 sm:p-4 lg:p-8 font-sans">
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 lg:p-8 w-full max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-4">
          ...
          <button className="flex-shrink-0 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex items-center justify-center gap-2">
            <svg
