...
const SurveyAndPoll: React.FC = () => {
  ...
  return (
    <div className="bg-[#f9f9fc] p-6 rounded-lg ">
      <h2 className="text-xl md:text-2xl font-semibold text-[rgba(78,83,177,1)] mb-2">Create New Survey & Poll</h2>
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col">
          ...
          <select
            id="type"
            className="w-48 px-6 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#3B3BDB]"
