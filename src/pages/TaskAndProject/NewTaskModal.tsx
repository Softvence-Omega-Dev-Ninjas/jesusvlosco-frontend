...
export default function NewTaskModal({ onClose, onTaskDetailsClick }: NewTaskModalProps) {
      ...
      <div className="bg-white w-full max-w-md rounded-xl p-6 shadow-xl relative">
        ...
        {!showDetails ? (
          <div className="space-y-6">
            ...
            <div onClick={() => setShowDetails(true)} className="flex items-center gap-2 text-[#4E53B1] cursor-pointer">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm underline text-[#4E53B1] cursor-pointer" onClick={onTaskDetailsClick}>
              Task Details
            </p>
        ...
        <div className="mt-6 flex justify-between items-center">
          <div className="flex gap-4">
            <button onClick={onClose} className="bg-[#4E53B1] hover:bg-[#3f45a0] text-white text-sm font-semibold px-5 py-2 rounded-md">
              Publish Task
            </button>
            <button
