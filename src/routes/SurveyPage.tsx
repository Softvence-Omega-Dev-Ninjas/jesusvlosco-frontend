// SurveyPage.tsx
import { FileText, PlusCircle, Star, Trash2, X } from "lucide-react";
...
export default function SurveyPage() {
  ...
  //Data States
  const [surveyTitle, setSurveryTitle] = useState("");

  const handleTitleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setSurveryTitle(event.target.value);
  };
    ...
    <div className="min-h-screen font-inter">
      <div
        className={`relative z-10 ${
          showModal ? "blur-[1px] pointer-events-none" : ""
        }`}
      >
          ...
          <div className="bg-white border border-gray-300 rounded-md ">
            ...
            <div className="grid grid-cols-1 max-w-2xl  sm:grid-cols-2 lg:grid-cols-1 gap-4 p-6">
              <div className="flex gap-4">
                <label className="text-lg mt-3 font-medium text-[rgba(78,83,177,1)] min-w-max">
                  Survey Title
                </label>
                <input
              ...
              <div className="flex gap-4">
                <label className="text-lg mt-3  text-[rgba(78,83,177,1)]">
                  Description
                </label>
            ...
            <div className="grid grid-cols-1 min-h-[600px] sm:min-h-[700px] md:min-h-[700px] lg:min-h-[800px]	 md:grid-cols-4 gap-0 border-gray-300 border-t">
              <div className="bg-gray-50 p-4  border-gray-300 border-r">
                <p className="text-sm text-center font-semibold mt-3 mb-4">
                  Add a field
                </p>
                <div className="space-y-3  ">
                  <button
                    onClick={() => addField("description")}
                    className="flex items-center  gap-2 text-sm w-full border border-gray-300 px-3 py-4 rounded-md bg-gray-50 hover:bg-gray-100"
                  >
            ...
            <div className="flex justify-end gap-2 border-t border-gray-300 px-6 py-4 bg-gray-50 rounded-b-md">
              ...
              <NavLink
                to={"/admin/publish-survey"}
                className="bg-[rgba(78,83,177,1)] text-white px-4 py-2 rounded-md text-sm hover:bg-indigo-700"
              >
                Publish Survey
              </NavLink>
            </div>
      ...
      <Modal isOpen={showModal}>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          >
            <img
              src="../src/assets/FrameCreate.png"
              alt="Edit"
      ...
      <OpenEndedFieldModal
        ...
        onSave={handleSaveOpenEnded}
      />
      <RatingFieldModal
        isOpen={showRatingModal}
        onClose={() => setShowRatingModal(false)}
        onSave={handleSaveRatingField}
      />
    </div>
  );
}
